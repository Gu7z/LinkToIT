...
import { StyleSheet, Text, View, Dimensions, StatusBar, Animated } from 'react-native';
    ...
    <NativeRouter>
      <View style={styles.container}>
        <SideBar open={open} style={{backgroundColor: 'powderblue'}}>
          <Text style={{fontSize: 28, textAlign: 'center', margin: 10}}>a</Text>
        </SideBar>
        <Icon onPress={()=>{setOpen(!open)}} style={{position: 'absolute', top: 25, left: 10, zIndex: 2}} name="menu" size={30} color={open ? "#000" : "#fff"} />
        <Route exact path="/" >
